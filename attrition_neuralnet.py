...
from keras.layers import Dense, Conv1D, GlobalAvgPool1D, Dropout
from keras import optimizers
from loss_plot import PlotLosses
...
def tensorboard(tag=""):
    time_str = datetime.now().isoformat()[
        :-7].replace("T", "_").replace(":", " ").replace(":", " ")
    return TensorBoard(log_dir="logs/{} {}".format(time_str, tag))
